...
<body>
   <fieldset><legend class = "legend">Delete user</legend>
       ...
       <p><a href="${pageContext.request.contextPath}/showUsers.jsp">Cancel</a>&nbsp;&nbsp;|&nbsp;&nbsp;
          <a href="${pageContext.request.contextPath}/deleteForSure.jsp?id=${param.id}">Delete the user</a></p>
   </fieldset>
</body>
</html>